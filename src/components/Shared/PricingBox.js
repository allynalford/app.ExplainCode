              ...
              >
                ...
                <CardBody>
                  ...
                  {(pricing.custom === true ? <div className="d-flex mb-4" name="pricingsection">
                    ...
                    {(pricing.price.yearly === "$0" | pricing.price.monthly === "$0" ? "" :  <span className="h4 align-self-end mb-1">
                  ...
                  {(pricing.header === "Starter" | pricing.header === "Pro" ? <p className="para-desc text">* No Credit Card Required to get started.</p> : "")}
                </CardBody>
              </Card>
            </Col>)
          }
