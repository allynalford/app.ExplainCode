    ...
    constructor(props) {
        ...
        this.state = {
            ...
            features : [
                ...
                { id : 3, icon : 'uil uil-comment-edit h1 text-primary', title : "Code Comments", description : "Save time and effort explaining unfamiliar code. Just enter your function or code snippet to get javadoc-formatted comments for your Javascript, NodeJS, Python, React, Golang or SQL code. Code Explain eliminates the need for developers to manual conceptual overviews and descriptions. " },
            ...
            languages : [
                ...
                { id : 1, lang: true, dataicon:"vscode-icons:file-type-sql", icon : 'uil uil-list-ul h1 text-primary', title : "SQL (Structured Query Language)", description : "It is the language used by databases in a universal way. It is widely used because it's easy to learn. Most programming languages incorporate modules that allow interaction with SQL databases, which enormously expands their capabilities and usages." },
                { id : 2, lang: true, dataicon:"vscode-icons:file-type-light-solidity", icon : 'uil uil-document-layout-left h1 text-primary', title : "Solidity - Coming soon", description : "Web3, NFT's and blockchain are the future. The Solidity programming language was influenced by C++ as well as JavaScript and its syntax is similar to the latter. It's a high level programming language designed to be written directly on the Ethereum Virtual Machine." },
                { id : 3, lang: true, dataicon:"vscode-icons:file-type-haskell2", icon : 'uil uil-comment-edit h1 text-primary', title : "Haskell - Coming soon", description : "Haskell (/ˈhæskəl/) is a general-purpose, statically typed, purely functional programming language with lazy evaluation. It's named for the logician Haskell Curry. The Plutus Platform is the smart contract platform for the Cardano (ADA) blockchain based on Haskell." },
            ],
            works : [
